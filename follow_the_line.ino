...
#include <QTRSensors.h> //Pololu QTR Sensor Library. First you must download and install QTRSensors library. In this case, you should install the 2014 version of QTRSensors lib.
// https://github.com/pololu/qtr-sensors-arduino/releases/tag/2.1.1
...
#define DEBUG 0
#define NUM_SAMPLES_PER_SENSOR  4  // average 4 analog samples per sensor reading. This is default value

//sensors 0 through 5 are connected to analog inputs 0 through 5, respectively
QTRSensorsAnalog qtrrc((unsigned char[]) { 0,1,2,3,4,5} ,NUM_SENSORS, NUM_SAMPLES_PER_SENSOR, EMITTER_PIN);
